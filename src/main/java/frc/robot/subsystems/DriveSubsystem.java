...
public class DriveSubsystem extends SubsystemBase {
  ...
  // drop in replacement for above obometry class - to alow addition of
  // vision/limelight data to update odometry
  ...
  /**
   * Method to rotate the robot to aim at april tag using Limelight data from LLSubsystem
   *    *
   * @param xSpeed        Speed of the robot in the x direction (forward).
   * @param ySpeed        Speed of the robot in the y direction (sideways).
   * @param rot           Angular rate of the robot.
   ...
   */
    ...
    public void TurnToAngle(double xSpeed, double ySpeed, double rot, boolean fieldRelative, boolean rateLimit){
  ...
  public void driveRobotRelative(ChassisSpeeds speeds) {
    drive(speeds.vxMetersPerSecond, speeds.vyMetersPerSecond, speeds.omegaRadiansPerSecond, false, false); // set rate
                                                                                                           // limiting
                                                                                                           // to false
                                                                                                           // for
                                                                                                           // PathPlanner
